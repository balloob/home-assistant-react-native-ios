...
function getRandomTime() {
    var ts = new Date(new Date().getTime() - Math.random() * 80 * 60 * 1000);
...
exports["default"] = [{
    ...
    attributes: {
        auto: true,
        entity_id: ["light.bowl", "light.ceiling", "light.tv_back_light", "light.bed_light"],
    ...
    attributes: {
        auto: false,
        entity_id: ["light.bed_light", "switch.christmas_lights"],
    ...
    attributes: {
        auto: false,
        entity_id: ["light.bowl", "light.ceiling", "light.tv_back_light", "switch.ac"],
